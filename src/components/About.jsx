      ...
      <div className="flex flex-col lg:flex-row justify-between items-center mb-12">
        <div className="w-full md:w-1/2 text-center md:text-left">
          <p className="text-lg mb-4">
            ...
            possimus quidem commodi voluptates, fugit error ea quod! Similique
            rerum eligendi quas, nemo deserunt incidunt, corrupti voluptatum
            commodi voluptates doloremque facilis ducimus quae tempora,
            temporibus odio beatae atque eveniet molestias cumque!
          </p>
        </div>
