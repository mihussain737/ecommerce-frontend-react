    ...
    <div className="grid md:grid-cols-5 grid-cols-4 md:text-md text-sm gap-4 items-center border-[1px] border-slate-600">
      <div className="md:col-span-2 justify-self-start flex flex-col gap-2">
          ...
          <div className="flex items-start gap-5 mt-3">
               <button className="flex items-center font-semibold space-x-2 px-4 py-1 text-xs border border-rose-600 rounded-md hover:bg-red-50 transition-colors duration-200"
     ...
     <div className="justify-self-center lg:text-[17px] font-semibold text-sm text-slate-600">
     ...
     <div className="justify-self-center text-lg font-semibold">
